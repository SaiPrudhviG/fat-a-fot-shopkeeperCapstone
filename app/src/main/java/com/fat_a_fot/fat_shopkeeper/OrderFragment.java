...
public class OrderFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void updateorderlist(final View view){
        ...
        showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_COMPLETEORDERS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    if (error) {
                        RecyclerViewAdapterCompletOrder adapter = new RecyclerViewAdapterCompletOrder(jObj.getJSONArray("order"),view.getContext());
                        RecyclerView myView =  (RecyclerView)getView().findViewById(R.id.recyclerviewcompletorder);
